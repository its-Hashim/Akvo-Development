...
#define ONE_WIRE_BUS 4  // Data wire is plugged into port 9 on the Arduino
...
void setup(void)
{
  ...
  for (int k =0; k < sensors.getDeviceCount(); k++) 
  {
    ...
    { 
      Serial.println(sensors.getResolution(T4), DEC);
    }
    else if (k == 4) 
    { 
      Serial.println(sensors.getResolution(T5), DEC);
    } 
    else if (k == 5) 
    {
      Serial.println(sensors.getResolution(T6), DEC);
    } 
    else if (k == 6) 
    {
      Serial.println(sensors.getResolution(T7), DEC);
    } 
    else if (k == 7) 
    {
      Serial.println(sensors.getResolution(T8), DEC);
    }  
 }
}
