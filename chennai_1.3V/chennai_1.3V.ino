...
void loop()
{
  if (thermocouple.readCelsius() >= 65)
  {
    turnOffComp();
    turnOffComp();
    turnOffComp();
  ...
  if (interval > 3000)
  {
    ...
    if (m >= 10)
    {
      ...
      s.print("field1=" + String(temp) + "&field2=" + String(humid) + "&field3=" + String(measureHeight(distance))
              + "&field4=" + String(digitalRead(comp)) +   "&field5="  + String(0)   + "&field6="  + String(tempC1) + "&field7=" + String(tempC2));
      Serial.println("logging data");
      Serial.println(temp);
...
void logData(int t)
{
  ...
  Serial.println("Logging data");
  s.print("field1=" + String(temp) + "&field2=" + String(humid) + "&field3=" + String(measureHeight(distance))
          + "&field4=" + String(digitalRead(comp)) +   "&field5="  + String(t)   + "&field6="  + String(tempC1) + "&field7=" + String(tempC2));
  Serial.println("logging data");
  Serial.println(temp);
  Serial.println(humid);
  Serial.println(tempC1);
